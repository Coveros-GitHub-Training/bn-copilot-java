...
> [!NOTE]
> **Do not assign this issue to @copilot yet!** You'll do that in Lab 9 when you learn about the Cloud Agent. For now, just create the issue and leave it unassigned.
...
- [ ] You understand how this issue will be used with Cloud Agent in the next lab
