...
> **Note**: In this lab, you'll practice with **Plan mode** and **Agent mode** to understand when to use each. **IDE Agent mode** (this lab) works interactively within VS Code, different from **Cloud Agent** (Lab 9) which works autonomously on GitHub issues.
...
Let's use Agent mode for a focused improvement to existing code in the homepage template.
...
4. **Request a targeted improvement:**
   ...
   Create a prompt that asks Copilot to add hover effects and improve the visual styling of the feature cards. Reference the specific file and section to keep the changes focused.

   <details>
   <summary>💡 Example Prompt</summary>

   ```
   In the features section of #index.html, enhance the feature cards with hover effects and improved styling. Add smooth transitions and subtle shadows that activate on hover. Keep the existing color scheme.
   ```
   </details>
