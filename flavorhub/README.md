...
A Spring Boot application for managing recipes, ingredients, and pantry items. This application is designed as a learning tool for the GitHub Copilot Workshop.
...
This project is part of the GitHub Copilot Workshop training materials.
